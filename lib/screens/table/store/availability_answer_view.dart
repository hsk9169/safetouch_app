...
class TablingStoreAvailabilityAnswerView extends StatefulWidget {
  final String vacancyId;
  TablingStoreAvailabilityAnswerView({required this.vacancyId});
  @override
  State<StatefulWidget> createState() => _TablingStoreAvailabilityAnswerView();
}

class _TablingStoreAvailabilityAnswerView
    extends State<TablingStoreAvailabilityAnswerView> {
