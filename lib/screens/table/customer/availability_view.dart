...
class TablingCustomerAvailabilityView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _TablingCustomerAvailabilityView();
}

class _TablingCustomerAvailabilityView
    extends State<TablingCustomerAvailabilityView> {
  ...
  Widget _renderGuide() {
    return Container(
        ...
        child: Text(
            "취소는 빈자리확인 내역 상단 오른쪽 취소 누르시고 변경은 상점문의 하시거나 취소후 다시 QR스캔후 '빈자리확인 / 예약 / 문의'에서 다시 신청해주세요",
            style: TextStyle(
